...
class RegistroClienteVentana:
    def __init__(self, controlador = None):
        ...
        self.concesionario_label = tk.Label(self.root, text="Concesionario:")
        self.concesionario_label.pack()
        self.concesionario_label = tk.Entry(self.root)
        self.concesionario_label.pack()
