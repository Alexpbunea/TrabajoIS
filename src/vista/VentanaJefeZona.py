...
class Ui_MainWindow_JefeZona(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.ventas.setGeometry(QtCore.QRect(20, 650, 151, 41))
        ...
        self.pago.setGeometry(QtCore.QRect(760, 650, 151, 41))
        ...
        self.lista = [self.Cliente, self.Trabajador, self.Taller, self.vehiculos, self.ventas, self.pago]
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Ventana del jefe de zona"))
